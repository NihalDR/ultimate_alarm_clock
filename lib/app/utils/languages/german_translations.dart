...
class GermanTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'de_DE': {
          ...
          'Sign-inDescription':
              'Die Anmeldung ist optional. Sie ist nur erforderlich für '
                  'Funktionen, die Cloud-Dienste nutzen, wie zum Beispiel:',
          'CollabDescription':
              'Zusammenarbeit mit Freunden, Familienmitgliedern oder '
                  'Kollegen, um sicherzustellen, dass sie rechtzeitig aufwachen, '
                  'indem geteilte Wecker verwendet werden.',
          'Syncing Across Devices': 'Synchronisation über Geräte hinweg',
          'AccessMultiple':
              'Greifen Sie auf Ihre Wecker von mehreren Geräten aus zu, wo '
                  'die Wecker in Echtzeit aktualisiert werden.',
          'Your privacy': 'Ihre Privatsphäre',
          'NoAccessInfo':
              'Wir greifen nicht auf Informationen zu, verwenden sie nicht '
                  'und verkaufen sie nicht, was Sie durch Überprüfen des '
                  'Quellcodes überprüfen können.',
          'LimitedAccess':
              'Alle Zugriffe sind ausschließlich darauf beschränkt, die '
                  'oben beschriebenen Funktionen bereitzustellen.',
          ...
          'This project was originally developed as part of Google Summer of '
              ...
              'Dieses Projekt wurde ursprünglich im Rahmen des Google Summer '
                  'of Code unter der Organisation CCExtractor entwickelt. Es ist '
                  'kostenlos, der Quellcode ist verfügbar, und wir ermutigen '
...
//alarm_id_tile.dart
          ...
          'toCopyAlarm':
              'Um die Alarm-ID zu kopieren, müssen Sie den gemeinsam '
                  'genutzten Alarm aktivieren!',
...
//maths_challenge_tile.dart
          ...
          'mathDescription':
              'Sie müssen einfache mathematische Probleme der gewählten '
                  'Schwierigkeitsstufe lösen, um den Alarm abzuschalten.',
          'Easy': 'Leicht',
          'Medium': 'Mittel',
          'Hard': 'Schwer',
...
// pedometer_challenge_tile.dart
          ...
          'pedometerDescription':
              'Schreiten Sie voran, um zu entlassen! Setzen Sie ein '
                  'Schrittziel, um den Wecker auszuschalten und einen aktiven und '
                  'energiegeladenen Start in den Tag zu fördern.',
...
// qr_bar_code_tile.dart
          ...
          'qrDescription':
              'Scannen Sie den QR-/Strichcode auf einem Objekt wie einem Buch '
                  'und verschieben Sie es in einen anderen Raum. Zum Deaktivieren '
                  'des Alarms scannen Sie einfach denselben QR-/Strichcode erneut.',
...
//screen_activity_tile.dart
          ...
          'screenDescription':
              'Diese Funktion storniert den Alarm automatisch, wenn Sie Ihr '
                  'Gerät für eine festgelegte Anzahl von Minuten verwenden.',
//shake_to_dismiss_tile.dart
          'Shake to dismiss': 'Schütteln zum Abbrechen',
          'shakeDescription':
              'Sie müssen Ihr Telefon eine festgelegte Anzahl von Malen '
                  'schütteln, um den Alarm abzubrechen - kein gemütliches '
                  'Schlummern mehr :)',
...
//'shared_alarm_tile.dart
          ...
          'sharedDescription':
              'Teilen Sie Alarme mit anderen mithilfe der Alarm-ID. Jeder '
                  'geteilte Benutzer kann wählen, ob sein Alarm vor oder nach der '
...
//weather_tile.dart
          ...
          'weatherDescription':
              'Diese Funktion storniert den Alarm automatisch, wenn das '
                  'aktuelle Wetter Ihren ausgewählten Wetterbedingungen entspricht '
                  'und ermöglicht so einen besseren Schlaf!',
          'To use this feature, you have to add an OpenWeatherMap API key!':
              'Um diese Funktion zu verwenden, müssen Sie einen '
                  'API-Schlüssel von OpenWeatherMap hinzufügen!',
...
//alarm_ring_view.dart
          ...
          'step2.1':
              'Wenn Sie bereits ein Konto haben, geben Sie Ihre Zugangsdaten '
                  'ein. Andernfalls klicken Sie auf die Option ',
          'step2.2': 'Create an Account',
          'step2.3': '. Sie werden aufgefordert, Ihren Benutzernamen, Ihre '
              'E-Mail-Adresse und Ihr Passwort einzugeben. Stellen Sie sicher, '
              'dass die Angaben korrekt sind.',
          'step3': 'Sobald Ihr Konto bereit ist, werden Sie automatisch zur '
              'OpenWeather-Seite weitergeleitet. Dabei werden Sie nach Ihrem '
              'Unternehmen und dem Zweck der Nutzung der Plattform gefragt, '
              'Füllen Sie diese Angaben entsprechend aus.',
          'step4.1': 'Klicken Sie auf Ihr ',
          'step4.2': 'Username',
          'step4.3':
              '(oben rechts). Es erscheint ein Dropdown-Menü. Klicken Sie auf '
                  'die Option ',
          'step4.4': 'My API',
          'step4.5': '.',
          'step5': 'Jetzt haben Sie den Wetter-API-Schlüssel. Wählen Sie den '
              'Schlüssel aus und kopieren Sie ihn.',
