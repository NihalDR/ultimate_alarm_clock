...
class LocationTile extends StatelessWidget {
  ...
  String _getLocationConditionDescription(LocationConditionType type) {
    switch (type) {
      ...
      case LocationConditionType.ringWhenAt:
        return ('Perfect for travel alarms - rings when you reach '
            'your destination');
      case LocationConditionType.cancelWhenAt:
        return ('Avoid redundant alarms - cancels if you\'re already '
            'where you need to be');
      case LocationConditionType.ringWhenAway:
        return ('Departure reminders - rings when you\'re away from '
            'important places');
      case LocationConditionType.cancelWhenAway:
        return ('Location-specific activities - cancels if you\'re too '
            'far away');
    }
  }
  ...
  void _showLocationPicker(
    ...
    LocationConditionType selectedType,
  ) {
    Get.bottomSheet(
      Container(
        height: height * 0.9,
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: FlutterMap(
                    ...
                    children: [
                      // OpenStreetMap TileLayer with improved error handling
                      // and rate limiting prevention.
                      // This config includes proper User-Agent headers and
                      // fallback options to prevent HTTP 403 errors.
                      TileLayer(
                        urlTemplate: ('https://{s}.tile.openstreetmap.org/'
                            '{z}/{x}/{y}.png'),
                        subdomains: const ['a', 'b', 'c'],
                        userAgentPackageName:
                            ('com.ccextractor.ultimate_alarm_clock'),
          ...
          if (type != LocationConditionType.off) {
            ...
            if (hasPermission) {
              ...
              Get.defaultDialog(
                ...
                content: const Text(
                  'Please provide all time location access to use '
                  'this feature.',
                  textAlign: TextAlign.center,
                ),
              );
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      Utils.showModal(
                        ...
                        description:
                            'Choose how location affects your alarm:\n\n'
                            '• Ring when AT: Alarm rings when you reach '
                            'the location\n'
                            // ignore: lines_longer_than_80_chars
                            '• Cancel when AT: Alarm cancels if you\'re already '
                            'there\n'
                            '• Ring when AWAY: Alarm rings when you\'re far '
                            'from location\n'
                            '• Cancel when AWAY: Alarm cancels if you\'re too '
                            'far\n\n'
                            'All conditions use a 500m radius.',
                        iconData: Icons.location_on,
                        isLightMode: themeController.currentTheme.value ==
                            ThemeMode.light,
                      );
                    },
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ...LocationConditionType.values
                              .where(
                                (type) => type != LocationConditionType.off,
                              )
                              .map(
