...
class PedometerChallenge extends StatelessWidget {
    ...
    return Obx(
      () => InkWell(
        onTap: () {
          ...
          _showPedometerSettingsBottomSheet(
            context,
            numberOfSteps,
            isPedometerEnabled,
          );
  ...
  void _showPedometerSettingsBottomSheet(
    BuildContext context,
    int initialNumberOfSteps,
    bool initialIsPedometerEnabled,
  ) {
                            ...
                            child: Obx(
                              () => Switch.adaptive(
                                ...
                                onChanged: (value) {
                                  ...
                                  if (!value) {
                                    controller.numberOfSteps.value = 0;
                                  } else if (controller.numberOfSteps.value ==
                                      0) {
                                ...
                                ? _buildSection(
                                    ...
                                    child: Column(
                                      children: [
                                        Obx(
                                          () => Text(
                                            controller.numberOfSteps.value
                                                .toString(),
                                            style: Theme.of(context)
                                                .textTheme
                                                .displaySmall
