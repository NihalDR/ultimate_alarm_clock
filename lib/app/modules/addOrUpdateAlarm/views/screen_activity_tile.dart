    ...
    return Column(
      children: [
        ListTile(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ('Choose how your alarm responds to your '
                                    'phone usage:'),
                              ...
                              _buildInfoItem(
                                ...
                                Icons.alarm,
                                'Ring When Active',
                                ('Alarm rings if you\'ve been using your '
                                    'phone within the time limit'),
                              ),
                              _buildInfoItem(
                                context,
                                Icons.alarm_off,
                                'Cancel When Active',
                                ('Alarm is cancelled if you\'ve been using '
                                    'your phone within the time limit'),
                              ),
                              _buildInfoItem(
                                context,
                                Icons.alarm_on,
                                'Ring When Inactive',
                                ('Alarm rings if you haven\'t used your '
                                    'phone for the specified time'),
                              ),
                              _buildInfoItem(
                                context,
                                Icons.cancel,
                                'Cancel When Inactive',
                                ('Alarm is cancelled if you haven\'t used '
                                    'your phone for the specified time'),
                              ),
                              const SizedBox(height: 20),
                              SizedBox(
                                width: width,
          ...
          trailing: Obx(
            () => Switch(
              value: controller.activityConditionType.value !=
                  ActivityConditionType.off,
              onChanged: (value) {
                Utils.hapticFeedback();
                if (value) {
                  controller.activityConditionType.value =
                      ActivityConditionType.cancelWhenActive;
        ...
        Obx(
          () => AnimatedContainer(
            ...
            height: controller.activityConditionType.value !=
                    ActivityConditionType.off
                ? null
                : 0,
            child: controller.activityConditionType.value !=
                    ActivityConditionType.off
                ? Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        ...ActivityConditionType.values
                            .where(
                              (type) => type != ActivityConditionType.off,
                            )
                            .map(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Obx(
                () => NumberPicker(
                  value: controller.activityInterval.value > 0
                      ? controller.activityInterval.value
                      : 1,
                  minValue: 1,
                  maxValue: 1440,
