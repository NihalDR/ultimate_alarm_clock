  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      try {
                  ...
                  onTap: () async {
                    try {
                      ...
                      if (controller.userModel.value == null) {
                        developer.log(
                          'Cannot toggle shared alarm: User not logged in',
                        );
                        return;
                      }

                      bool newValue = !controller.isSharedAlarmEnabled.value;
                      developer.log('Toggling shared alarm to: $newValue');
                      ...
                      developer.log('Error toggling shared alarm: $e');
                  ...
                  trailing: Obx(
                    () => Switch.adaptive(
                      onChanged: (value) async {
                        try {
                          Utils.hapticFeedback();
                          developer.log('Switch toggled to: $value');

                          // Add validation before changing
                          if (controller.userModel.value == null && value) {
                            developer.log(
                              'Cannot enable shared alarm: User not logged in',
                            );
                            return;
                          }
                          ...
                          developer.log('Error in switch toggle: $e');
                        }
                      },
        ...
        developer.log('Error in SharedAlarm widget build: $e');
