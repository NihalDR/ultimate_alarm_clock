...
class RussianTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ru_RU': {
          ...
          'Sign-inDescription':
              'Вход необязателен. Он требуется только для функций, '
                  'использующих облачные службы, таких как:',
          'CollabDescription':
              'Сотрудничество с друзьями, членами семьи или коллегами, '
                  'чтобы удостовериться, что они просыпаются вовремя с '
                  'использованием общих будильников.',
          'Syncing Across Devices': 'Синхронизация между устройствами',
          'AccessMultiple':
              'Доступ к вашим будильникам с нескольких устройств, где '
                  'будильники обновляются в реальном времени.',
          'Your privacy': 'Ваша конфиденциальность',
          'NoAccessInfo':
              'Мы не имеем доступа, не используем и не продаем никакую '
                  'информацию, что вы можете проверить, изучив исходный код.',
          'LimitedAccess':
              'Весь доступ ограничен исключительно предоставлением '
          ...
          'This project was originally developed as part of Google Summer of '
              ...
              'Этот проект изначально был разработан в рамках Google Summer '
                  'of Code под руководством организации CCExtractor. Он '
                  'бесплатен, исходный код доступен, и мы приглашаем '
                  'программистов внести свой вклад.',
...
//maths_challenge_tile.dart
          ...
          'Hard': 'Тяжелый',
          'mathDescription':
              'Вам нужно решать простые математические задачи выбранного '
                  'уровня сложности, чтобы отключить будильник.',
...
// qr_bar_code_tile.dart
          ...
          'qrDescription':
              'Отсканируйте QR-код / Штрих-код на любом объекте, например, '
                  'на книге, и переместите его в другую комнату. Чтобы '
                  'отключить будильник, просто повторно отсканируйте тот же '
                  'QR-код / Штрих-код.',
...
//screen_activity_tile.dart
          ...
          'screenDescription':
              'Эта функция автоматически отменяет будильник, если вы '
                  'используете свое устройство в течение установленного '
                  'количества минут.',
//shake_to_dismiss_tile.dart
          'Shake to dismiss': 'Встряхнуть для отклонения',
          'shakeDescription':
              'Вам нужно встряхнуть телефон установленное количество раз, '
                  'чтобы отклонить будильник - больше ленивого откладывания :)',
...
//'shared_alarm_tile.dart
          ...
          'sharedDescription':
              'Делитесь будильниками с другими, используя ID будильника. '
                  'Каждый общий пользователь может выбрать, звонить ли его '
                  'будильнику до или после установленного времени.',
          'Understood': 'Понял',
          'To use this feature, you have to link your Google account!':
              'Чтобы использовать эту функцию, вы должны связать свою учетную '
                  'запись Google!',
...
//weather_tile.dart
          ...
          'weatherDescription':
              'Эта функция автоматически отменяет будильник, если текущая '
                  'погода соответствует вашим выбранным погодным условиям, что '
                  'позволяет вам спать лучше!',
          'To use this feature, you have to add an OpenWeatherMap API key!':
              'Чтобы использовать эту функцию, вы должны добавить ключ API от '
                  'OpenWeatherMap!',
...
//maths_challenge_view.dart
          ...
          'pedometerDescription':
              'Шагайте, чтобы отключить! Установите цель по количеству шагов, '
                  'чтобы выключить будильник и активизировать начало дня с '
                  'энергией.',
...
//alarm_ring_view.dart
          ...
          'step1.4': 'SignIn',
          'step1.5':
              ' (в правом верхнем углу) затем он запрашивает учетные данные '
                  'для входа.',
          'step2.1': 'Если у вас уже есть учетная запись, введите свои учетные '
              'данные. В противном случае нажмите на опцию ',
          'step2.2': 'Create an Account',
          'step2.3':
              ' . Он просит вас ввести имя пользователя, адрес электронной '
                  'почты и пароль. Убедитесь, что введенные данные верны.',
          'step3': 'Как только ваша учетная запись будет создана, вы '
              'автоматически будете перенаправлены на страницу OpenWeather. '
              'Он спрашивает вас о вашей компании и цели использования '
              'платформы., заполните эти данные соответствующим образом.',
          'step4.1': 'Нажмите на ',
          'step4.2': 'Username',
          'step4.3': '(в правом верхнем углу). Появится раскрывающееся меню. '
              'Нажмите на опцию ',
          'step4.4': 'My API',
          'step4.5': '.',
