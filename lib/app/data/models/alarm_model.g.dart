...
void _alarmModelSerialize(
  ...
  writer.writeStringList(offsets[59], object.tasks);
  writer.writeString(offsets[60], object.timezoneId);
  writer.writeDouble(offsets[61], object.volMax);
  writer.writeDouble(offsets[62], object.volMin);
  writer.writeLong(offsets[63], object.weatherConditionType);
  writer.writeLongList(offsets[64], object.weatherTypes);
}
...
AlarmModel _alarmModelDeserialize(
  ...
  final object = AlarmModel(
    ...
    tasks: reader.readStringList(offsets[59]) ?? const [],
    timezoneId: reader.readStringOrNull(offsets[60]) ?? '',
    volMax: reader.readDouble(offsets[61]),
    volMin: reader.readDouble(offsets[62]),
    weatherConditionType: reader.readLong(offsets[63]),
    weatherTypes: reader.readLongList(offsets[64]) ?? [],
  );
...
extension AlarmModelQueryFilter
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> tasksIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'tasks',
        0,
...
extension AlarmModelQueryWhereDistinct
  ...
  QueryBuilder<AlarmModel, AlarmModel, QDistinct> distinctByTasks() {
    return QueryBuilder.apply(this, (query) {
...
extension AlarmModelQueryProperty
  ...
  QueryBuilder<AlarmModel, List<String>, QQueryOperations> tasksProperty() {
    return QueryBuilder.apply(this, (query) {
